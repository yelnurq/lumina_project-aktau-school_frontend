...
export default function NewsDetails() {
  ...
  const imageUrl = news.image
    ? `https://aktau-it-school.lumina.kz/storage/${news.image}`
    : 'https://aktau-it-school.lumina.kz/preview-image.png';
...
const jsonLd = {
  ...
  "publisher": {
    ...
    "logo": {
      "@type": "ImageObject",
      "url": "https://aktau-it-school.lumina.kz/favicon-96x96.png"
    }
  },
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": `https://aktau-it-school.lumina.kz/articles/${news.slug}`
  },
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:url" content={`https://aktau-it-school.lumina.kz/articles/${news.slug}`} />
            ...
            <div className={styles.relatedGrid}>
              {relatedNews.map((item) => (
                <Link to={`/articles/${item.slug}`} key={item.id} className={styles.relatedCard}>
                  <img src={`https://aktau-it-school.lumina.kz/storage/${item.image}`} alt={item.title} />
